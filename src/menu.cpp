...
{
    std::cout << "===========================================" << std::endl;
    std::cout << "=    C++ - Semaine 1 - Mot mystere plus   =" << std::endl;
    std::cout << "===========================================" << std::endl;
...
void displayAboutMenu()
{
    ...
    std::cout << "Name : Guerrier Numerique" << std::endl;
    std::cout << "GitHub : https://github.com/GuerrierNumerique" << std::endl;
    std::cout << "YouTube : Guerrier Numérique" << std::endl;
